...
TRANSLATIONS = {
    'uz': {
        ...
        'start_description': '"Spam tashlama, sticker yuborma, link tashlama, bolam!" deyma.\nMen sizning guruhingizadagi yagona nazoratchi va detektiv bo\'laman!',
        'start_instructions': '✨ Men qiladigan ishlar:',
        'start_list_1': '• Yangi kelganlarga **"Xush kelibsiz xabari!"** yuboraman 👋',
        'start_list_2': '• Agar 2 soniya ichida tugmani bosmasa, chiqaraman ✋',
        'start_list_3': '• Kirdi chiqdi va boshqa keraksiz xabarlarni o\'chiraman 🗑️',
        'start_list_4': '• Gap unmunasip! "Ogohlantirildi!" ❗ va gap qaytarishni davom etsa, ban qilatman 🚫',
        'start_list_5': '• Xavfli xabarlar — sticker, gif, ovozli, video — hammasini nazorat qilib turaman 👀',
        'start_list_6': '• Qoidalarni eslataman va "kim qoidalari qayta buzaa" jimlataman 🔇',
        'start_list_7': '• Kim qancha gapiganini ham hisoblob boraman 📊',
        'start_footer': '🔥 Xullas, men bor guruhda:',
        'start_footer_text': '• Tartib va intizom bo\'ladi lekin spam bo\'tmaydi',
        'start_commands_header': '👉 Meni guruhingizga qo\'shing va admin qiling (xabarlarni o\'chirish huquqini berishni unutmang) 🛡️',
        'start_commands_text': 'Barcha buyruq va funksiyalarni ko\'rish uchun quyidagi \'Barcha buyruqlar\' tugmasini bosing ',
